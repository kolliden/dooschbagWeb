        ...
        <header className="relative overflow-hidden border-b border-zinc-800 bg-zinc-950/80">
            <div className="relative z-10 py-6">
                ...
                <div className="flex md:flex-row ml-16 gap-4">
                    ...
                    <p className="mt-0 text-zinc-400 md:max-w-[16ch] md:whitespace-pre-line md:leading-tight">
                        That&apos;s the name
                        <br />
                        of the Band
                    </p>
                ...
                {/* Navigation */}
                <nav className="mt-6">
                    <ul className="flex flex-wrap justify-center items-center gap-x-4 md:gap-x-26 text-sm uppercase font-bold tracking-wide">
                        {navItems.map((item, idx) => (
                            <React.Fragment key={item.name}>
                                ...
                                {idx < navItems.length - 1 && (
                                    <span className="hidden md:inline mx-2 border-l border-zinc-800 p-2"></span>
                                )}
                            </React.Fragment>
                        ))}
                    </ul>
